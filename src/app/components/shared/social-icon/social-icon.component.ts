...
@Component({
  ...
  imports: [],
  template: `
  <a [href]='hrefLink()' target="_blank" rel="noopener noreferrer" class="flex items-center justify-center rounded-full border-[2px] border-neutral-700 text-neutral-700
